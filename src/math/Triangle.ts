...
export class Triangle {
  ...
  public midpoint(ot: Vector3 = new Vector3()): Vector3 {
    return ot.addVectors(this.a, this.b).add(this.c).multiplyScalar(1 / 3);
  }
  ...
  public plane(optionalTarget: Plane = new Plane()): Plane {
    return optionalTarget.setFromCoplanarPoints(this.a, this.b, this.c);
  }

  public barycoordFromPoint(point: Vector3, ot: Vector3): Vector3 {
    return Triangle.barycoordFromPoint(point, this.a, this.b, this.c, ot);
  }
  ...
  public closestPointToPoint(point: Vector3, ot: Vector3 = new Vector3()) {
    let plane = new Plane();
    let edgeList = [new Line3(), new Line3(), new Line3()];
    let projectedPoint = new Vector3();
    let closestPoint = new Vector3();

    let result = ot || new Vector3();
