...
export class WebGLProgram {
  ...
  constructor(renderer, code, material, parameters) {
    ...
    if (this.gl.getProgramParameter(program, this.gl.LINK_STATUS) === false) {
      runnable = false;
      console.error('WebGLProgram: shader error: ', this.gl.getError(), 'gl.VALIDATE_STATUS', this.gl.getProgramParameter(program, this.gl.VALIDATE_STATUS), 'gl.getProgramInfoLog', programLog, vertexLog, fragmentLog);
    } else if (programLog !== '') {
