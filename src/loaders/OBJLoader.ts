...
interface State {
  ...
  finalize: Function;
  parseVertexIndex: Function;
  parseNormalIndex: Function;
  parseUVIndex: Function;
  addVertex: Function;
  addVertexLine: Function;
  addNormal: Function;
  addUV: Function;
  addUVLine: Function;
  addFace: Function;
  addLineGeometry: Function;
}
...
export class OBJLoader {
  ...
  public setPath(v: string): void {
    this.path = v;
  }

  public setMaterials(materials): void {
